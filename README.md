...
<div align="center">
  ...
  <p>
    <em>Transformant des idées en applications web performantes et adaptatives</em>
  </p>
...
const developpeur = {
    ...
    passion: ["Code propre", "UX/UI", "Performance", "Innovation"],
    philosophie: "Créer des solutions web élégantes qui font la différence",
...
⚡ **Spécialités** : Architecture front-end moderne, développement back-end robuste, respect des standards W3C  
🌟 **Approche** : Code maintenable, bonnes pratiques, performance optimale  
...
- ✨ Développement d'interfaces modernes avec  **React** , **Vue.js**
...
- 🔄 Gestion d'état avancée (Redux, ContextApi, Vuex)
- 🎭 Préprocesseurs CSS (**Sass**) et animations fluides
- 🌐 Standards W3C et accessibilité (WCAG)
...
- 🏗️ Architecture **PHP POO** avec **Laravel**
- 🛒 Développement e-commerce avec **PrestaShop**
- 📝 Gestion de contenu avec **WordPress** & **Drupal**
- 🔐 Authentification & autorisation (JWT, OAuth, Sanctum)
- 📡 Conception d'APIs RESTful robustes
- 🗄️ Design de bases de données (**MySQL**, **PostgreSQL**)
- 🧪 Tests unitaires et d'intégration
- 📦 Gestion de packages avec Composer & npm
...
class AhmedKhemiri extends Developpeur
{
    protected array $competences = [
        'frontend' => ['React', 'Vue.js', 'JavaScript ES6+', 'jQuery','Css','Sass', 'Tailwind', 'Bootstrap'],
        'backend' => ['PHP POO', 'Laravel'],
        'cms' => ['WordPress', 'PrestaShop', 'Drupal'],
        'devops' => ['Docker', 'Jenkins', 'SonarQube'],
        'databases' => ['MySQL', 'PostgreSQL'],
        'versionControl' => ['Git (GitHub)', 'SVN'],
        'methodologie' => ['Agile Scrum', 'UML'],
    ...
    public function mesAtouts(): array
    {
        return [
            ...
            '✅ Expertise CMS & E-Commerce (WordPress, PrestaShop, Drupal)',
            '✅ Code propre et maintenable (PSR, ESLint, SonarQube)',
            '✅ Respect strict des normes W3C',
